...
export default function Tabs({ activeTab, onTabChange, tabs, counts = {}, hasNewIssueMarker = false }) {
  return (
        ...
        return (
          ...
          >
            <View className="flex-row items-center">
              ...
              {tab === 'Issues' ? (
                hasNewIssueMarker && <View className="ml-1.5 w-2 h-2 rounded-full bg-[#DC3545]" />
              ) : (
                count > 0 && (
                  <View 
