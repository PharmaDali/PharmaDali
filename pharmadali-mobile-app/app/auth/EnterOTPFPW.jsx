    ...
    >
      <ScrollView className="w-full" 
        ...
        showsVerticalScrollIndicator={false}>
          ...
          <Text className="text-center mt-10 font-semibold" style={{ color: colors.textColor }}>
            Didn't receive the code? <Link href="#" className="text-blue-400" style={{ color: colors.buttonColor }}>Resend OTP</Link>
          </Text>
          <CustomButton className="mt-10 w-40" title="I-submit ang code" onPress={() => {
            router.push('auth/CreateNewPasswordFPW');
          }} />
      </ScrollView>
    </KeyboardAvoidingView>
