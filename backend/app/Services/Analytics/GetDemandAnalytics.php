...
class GetDemandAnalytics
{
    ...
    /**
     * Handle Demand Analytics calculation (Top Products with period-over-period delta).
     */
    public function handle(int $pharmacyId, ?string $startDate = null, ?string $endDate = null, int $limit = 10): array
    {
